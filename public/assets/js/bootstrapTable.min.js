...
!(function (t, e) {
  ...
  var C,
    ...
    ht = ct && ct.v8
  ht && (P = (C = ht.split('.'))[0] > 0 && C[0] < 4 ? 1 : +(C[0] + C[1])),
    !P &&
      at &&
      (!(C = at.match(/Edge\/(\d+)/)) || C[1] >= 74) &&
      (C = at.match(/Chrome\/(\d+)/)) &&
      (P = +C[1])
  var ut = P,
    dt = ut,
    ...
    Tt = function (t) {
      if (kt(t)) return t
      throw new Pt(Ct(t) + ' is not a function')
    },
    It = Tt,
    At = M,
    $t = function (t, e) {
  ...
  var Ut = Ft.exports,
    ...
    ue = function (t) {
      return (
        oe(ce, t) || (ce[t] = ae && oe(le, t) ? le[t] : he('Symbol.' + t)),
        ce[t]
      )
    },
    de = w,
    ...
    ve = function (t, e) {
      var i, n
      if ('string' === e && Et((i = t.toString)) && !jt((n = Rt(i, t))))
        return n
    ...
    ye = function (t, e) {
      ...
      if (n) {
        if (
          (void 0 === e && (e = 'default'), (i = de(n, t, e)), !pe(i) || fe(i))
        )
          return i
  ...
  var Vi = {
      ...
      getterFor: function (t) {
        return function (e) {
          var i
          if (!Ti(e) || (i = gi(e)).type !== t)
            throw new _i('Incompatible receiver, ' + t + ' required')
          return i
        }
      },
    },
    ...
    Pn = function (t) {
      return function (e, i, n) {
        ...
        if (t && i != i) {
          ...
          for (; r > s; s++) if ((t || s in o) && o[s] === i) return t || s || 0
        return !t && -1
      }
    },
    Tn = { includes: Pn(!0), indexOf: Pn(!1) },
    In = Xt,
    An = K,
    $n = Tn.indexOf,
    Rn = ki,
  ...
  Ir.f =
    Er && !jr
      ...
      : function (t, e) {
          Fr(t)
          for (var i, n = Nr(e), o = Dr(e), r = o.length, a = 0; r > a; )
            _r.f(t, (i = o[a++]), n[i])
          return t
        }
  var Vr,
  ...
  ;[].keys &&
    ('next' in (Ca = [].keys())
      ? (ka = Ba(Ba(Ca))) !== Object.prototype && (Oa = ka)
      : (Ma = !0))
  var Ua =
    !Va(Oa) ||
    Na(function () {
  ...
  var za = { IteratorPrototype: Oa, BUGGY_SAFARI_ITERATORS: Ma },
    ...
    Ka = function (t, e, i) {
      t && !i && (t = t.prototype),
        t && !Wa(t, Ga) && qa(t, Ga, { configurable: !0, value: e })
    },
      ...
      ('__proto__' in {}
        ? (function () {
            var t,
              ...
              i = {}
            try {
              ;(t = ss(Object.prototype, '__proto__', 'set'))(i, []),
    ...
    Fs = function (t, e, i, n, o, r, a) {
      ...
      if (
        (v &&
          ...
          s.next &&
          (gs(s) !== Os && (vs ? vs(s, Os) : ps(s[Cs]) || ys(s, Cs, As)),
          bs(s, u, !0)),
        Ss &&
          o === Ts &&
          f &&
        ...
        if (((l = { values: h(Ts), keys: r ? g : h(Ps), entries: h(Is) }), a))
    ...
    { target: 'Array', proto: !0, forced: !hl },
    {
      slice: function (t, e) {
        ...
        if (
          ...
          return cl(r, s, l)
        for (
          n = new (void 0 === i ? dl : i)(pl(l - s, 0)), o = 0;
          s < l;
          s++, o++
        )
          s in r && sl(n, o, r[s])
  ...
  var fl = Ot,
    ...
    vl = function (t, e) {
      if (!delete t[e])
        throw new gl('Cannot delete property ' + fl(e) + ' of ' + fl(t))
    },
    bl = Io,
    ml = String,
    yl = function (t) {
    ...
    Cl = !!kl && +kl[1],
    Pl = /MSIE|Trident/.test(ot),
    Tl = ot.match(/AppleWebKit\/(\d+)\./),
    Il = !!Tl && +Tl[1],
    Al = ho,
    $l = E,
    Rl = Tt,
  ...
  var Jl = v,
    ...
    ac = tc
      ? function (t, e) {
          if (Xl(t) && !Zl(t, 'length').writable)
            throw new Ql('Cannot set read only .length')
          return (t.length = e)
        }
      : function (t, e) {
          return (t.length = e)
  ...
  ec(
    { target: 'Array', proto: !0, forced: !uc },
    {
      splice: function (t, e) {
        ...
        if (((o.length = n), i < n)) {
          for (r = h; r < c - n; r++)
            (s = r + i), (a = r + n) in l ? (l[s] = l[a]) : hc(l, s)
          for (r = c; r > c - n + i; r--) hc(l, r - 1)
        } else if (i > n)
          for (r = c - n; r > h; r--)
            (s = r + i - 1), (a = r + n - 1) in l ? (l[s] = l[a]) : hc(l, s)
  ...
  var fc = p,
    ...
    Tc = function (t) {
      return function (e) {
        var i = xc(Sc(e))
        return 1 & t && (i = kc(i, Cc, '')), 2 & t && (i = kc(i, Pc, '$1')), i
      }
    },
    Ic = { start: Tc(1), end: Tc(2), trim: Tc(3) },
    Ac = ho,
    $c = v,
    Rc = p,
    Ec = fc,
    ...
    Zc = function (t) {
      ...
      if ('string' == typeof c && c.length > 2)
        if (((c = qc(c)), 43 === (e = Xc(c, 0)) || 45 === e)) {
          ...
          for (a = (r = Jc(c, 2)).length, s = 0; s < a; s++)
            if ((l = Xc(r, s)) < 48 || l > o) return NaN
          return parseInt(r, n)
        }
      return +c
    },
  ...
  var nh = v,
    ...
    gh =
      ...
      ah(function () {
        ...
        ? function (t, e) {
            for (
              var i = hh(t), n = arguments.length, o = 1, r = lh.f, a = ch.f;
              n > o;
    ...
    vh = gh
  ho(
    { target: 'Object', stat: !0, arity: 2, forced: Object.assign !== vh },
    { assign: vh }
  )
  var bh = v,
    mh = g,
    ...
    Ph = function (t) {
      return function (e) {
        for (
          ...
          (i = o[s++]),
            (bh && !(r ? i in n : Oh(n, i))) || kh(l, t ? [i, n[i]] : n[i])
        return l
      }
    },
    Th = { entries: Ph(!0), values: Ph(!1) }.entries
  ho(
  ...
  var Zh = Q,
    ...
    hu = function (t) {
      var e = t.flags
      return void 0 !== e || 'flags' in cu || au(t, 'flags') || !su(cu, t)
        ? e
        : ru(lu, t)
    },
    uu = g,
    ...
    wu = function (t, e, i) {
      return (
        i.get && bu(i.get, e, { getter: !0 }),
        i.set && bu(i.set, e, { setter: !0 }),
        mu.f(t, e, i)
      )
    },
    Su = v,
    ...
    ud =
      ...
      (!ld ||
        ...
        zu(function () {
          return (
            (sd[Ju] = !1),
            Xu(ad) !== ad || Xu(sd) === sd || '/a/i' !== String(Xu(ad, 'i'))
          )
        }))
  if (Eu('RegExp', ud)) {
    for (
                  ...
                  if ('\\' === (e = ed(t, n))) e += ed(t, ++n)
                    ...
                    switch (!0) {
                      case '[' === e:
                        ...
                        break
                      case '(' === e:
                        td(rd, od(t, n + 1)) && ((n += 2), (l = !0)),
                          (o += e),
                          c++
                        continue
                      case '>' === e && l:
                        if ('' === h || qu(a, h))
                          throw new Zu('Invalid capture group name')
  ...
  var gd = w,
    ...
    Rd = (function () {
      var t = /a/,
        e = /b*/g
      return (
        gd(Cd, t, 'a'), gd(Cd, e, 'a'), 0 !== t.lastIndex || 0 !== e.lastIndex
      )
    })(),
    Ed = yd.BROKEN_CARET,
    jd = void 0 !== /()??/.exec('')[1]
  ;(Rd || jd || Ed || xd || Od) &&
    (Pd = function (t) {
      ...
      if (
        ...
        for (o.groups = a = wd(null), r = 0; r < d.length; r++)
          a[(s = d[r])[0]] = o[s[1]]
      return o
    })
  var _d = Pd
  ...
  vp('search', function (t, e, i) {
    return [
      ...
      function (t) {
        ...
        var s = xf(n, o)
        return (
          yf(n.lastIndex, a) || (n.lastIndex = a), null === s ? -1 : s.index
        )
      },
    ]
  })
  var Of = Ho,
    ...
    Nf = function (t, e) {
      var i,
        n = Pf(t).constructor
      return void 0 === n || If((i = Pf(n)[Af])) ? e : Tf(i)
    },
    Df = Pp,
    Vf = wn,
    Bf = yl,
      ...
      return [
        ...
        function (t, o) {
          ...
          for (var p = 0, f = 0, g = []; f < a.length; ) {
            ...
            if (
              null === b ||
              (v = zf(Vf(u.lastIndex + (Uf ? f : 0)), a.length)) === p
            )
              f = Df(a, f, c)
            else {
              if ((qf(g, Wf(a, p, f)), g.length === d)) return g
              for (var m = 1; m <= b.length - 1; m++)
                if ((qf(g, b[m]), g.length === d)) return g
              f = p = v
            }
          }
  ...
  Pg(
    {
      ...
      forced:
        !!(
          Ng || ((Cg = Ig(String.prototype, 'endsWith')), !Cg || Cg.writable)
        ) && !Ng,
    },
    {
      endsWith: function (t) {
    ...
    return [
      ...
      function (t) {
        ...
        for (var s, l = [], c = 0; null !== (s = qg(n, o)); ) {
          var h = Hg(s[0])
          ;(l[c] = h),
            '' === h && (n.lastIndex = zg(o, Lg(n.lastIndex), a)),
            c++
        }
        return 0 === c ? null : l
      },
        ...
        this.scrollEl.addEventListener('scroll', o, !1),
          (this.destroy = function () {
            ;(i.contentEl.innerHtml = ''),
              i.scrollEl.removeEventListener('scroll', o, !1)
          })
      }
      return (
        r(t, [
        ...
        r(e, [
          ...
          },
          {
            ...
            value: function () {
              ...
              'string' == typeof e.icons &&
                (e.icons = ov.calculateObjectValue(null, e.icons)),
                (e.iconsPrefix =
                  e.iconsPrefix ||
                  t.fn.bootstrapTable.defaults.iconsPrefix ||
                  n),
                (e.icons = Object.assign(
                  ov.getIcons(e.iconsPrefix),
              ...
              ;(this.constants.buttonsClass = [
                ...
                .join(' ')
                .trim()),
                (this.buttons = ov.calculateObjectValue(
                  this,
                  e.buttons,
                  [],
                  {}
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                (this.options.columns = ov.extend(
                  !0,
                  [],
                  n,
              ...
              ;(this.header = {
                ...
                this.options.columns.forEach(function (t, r) {
                  ...
                  s.push(
                    '<tr'
                      .concat(
                        ov.sprintf(' class="%s"', e._headerTrClasses[r]),
                        ' '
                      )
                      .concat(
                        ov.sprintf(' style="%s"', e._headerTrStyles[r]),
                        '>'
                      )
                  )
                  var l = ''
                    ...
                    t.forEach(function (t, o) {
                      ...
                      if (
                        ...
                        if (Object.keys(t._data || {}).length > 0)
                          for (
                            var k = 0, C = Object.entries(t._data);
                            k < C.length;
                            k++
                          ) {
                            var P = a(C[k], 2),
                        ...
                        s.push(
                          '<th'.concat(
                            ov.sprintf(' title="%s"', t.titleTooltip)
                          ),
                          t.checkbox || t.radio
                            ? ov.sprintf(
                                ' class="bs-checkbox %s"',
          ...
          },
          {
            ...
            value: function () {
              ...
              for (
                var c = {}, u = 0, d = Object.entries(this.buttons);
                u < d.length;
                u++
              ) {
                var p = a(d[u], 2),
              ...
              for (
                ...
                I()
              if (o.showColumns) {
                var R = (e = this.$toolbar.find('.keep-open')).find(
              ...
              if (
                ...
                if (o.showSearchButton || o.showSearchClearButton) {
                  var L =
                    (o.showSearchButton ? N : '') +
                    (o.showSearchClearButton ? D : '')
                  B = o.search
                    ? ov.sprintf(this.constants.html.inputGroup, V, L)
                    : L
                }
                r.push(
                  ov.sprintf(
            ...
            value: function () {
              ...
              if (
                ...
                if (this.options.customSearch)
                  return (
                    (this.data = ov.calculateObjectValue(
                      this.options,
                      this.options.customSearch,
                      [this.options.data, this.searchText, this.filterColumns]
                    )),
                    this.options.sortReset &&
                      (this.unsortedData = s(this.data)),
                    void this.initSort()
                  )
                var e =
                    this.searchText &&
                    (this.fromHtml
                      ? ov.escapeHTML(this.searchText)
                      : this.searchText),
                  i = e ? e.toLowerCase() : '',
                  n = ov.isEmptyObject(this.filterColumns)
                    ? null
                    : this.filterColumns
                this.options.searchAccentNeutralise &&
                  (i = ov.normalizeAccent(i)),
                        ...
                        if (
                          ...
                          if (
                            (t.options.searchAccentNeutralise &&
                              (c = ov.normalizeAccent(c)),
                            l &&
                              l.searchFormatter &&
                              (c = ov.calculateObjectValue(
                                l,
                ...
                if (
                  ...
                  var p =
                      ...
                      !this._paginationLoaded
                        ? ' +'
                        : ''),
                    f = this.paginationParts.includes('pageInfoShort')
                      ? e.formatDetailPagination(p)
                      : e.formatShowingRows(
                          this.pageFrom,
                          this.pageTo,
                          p,
                  ...
                  d.forEach(function (i, n) {
                    ...
                    ;(!e.smartDisplay ||
                      ...
                      ((o = h
                        ...
                        : ''),
                      g.push(
                        ov.sprintf(t.constants.html.pageDropdownItem, o, i)
                      ))
                  }),
                    g.push(
                ...
                if (
                  ...
                  c.push(
                    ...
                    ov.sprintf(
                      ...
                      ov.sprintf(' pagination-%s', e.iconSize)
                    ),
                    ov.sprintf(
            ...
            value: function (t, e, n, o) {
              ...
              if (!(ov.findIndex(this.hiddenRows, t) > -1)) {
                ...
                if (t._data && !ov.isEmptyObject(t._data))
                  for (
                    var O = 0, k = Object.entries(t._data);
                    O < k.length;
                    O++
                  ) {
                    var C = a(k[O], 2),
                    ...
                    h += ' data-'
                      .concat(P, "='")
                      .concat('object' === i(T) ? JSON.stringify(T) : T, "'")
                  }
                s.push(
                  '<tr',
                  ...
                  ov.sprintf(
                    ' data-uniqueid="%s"',
                    ov.getItemField(t, this.options.uniqueId, !1)
                  ),
                  ov.sprintf(
                    ' data-has-detail-view="%s"',
                    this.options.detailView &&
                      ov.calculateObjectValue(null, this.options.detailFilter, [
                        e,
                        t,
                      ])
                      ? 'true'
                    ...
                    if (
                      ...
                      if (
                        (c.concat([r.header.styles[n]]).length &&
                          (b += ''.concat(
                            c.concat([r.header.styles[n]]).join('; ')
                          )),
                        t['_'.concat(i, '_style')] &&
                          (b += ''.concat(t['_'.concat(i, '_style')])),
                        b && (v = ' style="'.concat(b, '"')),
                        t['_'.concat(i, '_id')] &&
                          (f = ov.sprintf(' id="%s"', t['_'.concat(i, '_id')])),
                        t['_'.concat(i, '_class')] &&
                          (g = ov.sprintf(
                            ' class="%s"',
                            t['_'.concat(i, '_class')]
                        ...
                        (p = ov.calculateObjectValue(
                          r.header,
                          r.header.cellStyles[n],
                          [h, t, e, i],
                          p
                        ...
                        for (
                          var x = [], O = 0, k = Object.entries(p.css);
                          O < k.length;
                          O++
                        ) {
                          var C = a(k[O], 2),
                            P = C[0],
                            T = C[1]
                          x.push(''.concat(P, ': ').concat(T))
                        }
                        v = ' style="'.concat(
                          x.concat(r.header.styles[n]).join('; '),
                          '"'
                        )
                      }
                      if (
                        ((u = ov.calculateObjectValue(
                          o,
                          r.header.formatters[n],
                          [h, t, e, i],
                          h
                        )),
                        o.checkbox ||
                          o.radio ||
                          (u = null == u ? r.options.undefinedText : u),
                        o.searchable &&
                          r.searchText &&
                        ...
                        var I = '',
                          A = r.searchText.replace(
                            /[.*+?^${}()|[\]\\]/g,
                            '\\$&'
                          )
                        if (r.options.searchAccentNeutralise) {
                          var $ = new RegExp(
                            ''.concat(ov.normalizeAccent(A)),
                            'gmi'
                          ).exec(ov.normalizeAccent(u))
                      ...
                      if (
                        t['_'.concat(i, '_data')] &&
                        !ov.isEmptyObject(t['_'.concat(i, '_data')])
                      )
                        for (
                          var F = 0,
                            N = Object.entries(t['_'.concat(i, '_data')]);
                          F < N.length;
                          F++
                        ) {
                          var D = a(N[F], 2),
                      ...
                      if (o.checkbox || o.radio) {
                        ...
                        var L = o.class || '',
                          H =
                            ov.isObject(u) && u.hasOwnProperty('checked')
                              ? u.checked
                              : (!0 === u || h) && !1 !== u,
                        ...
                        ;(l = [
                          ...
                          '<label>\n            <input\n            data-index="'
                            .concat(e, '"\n            name="')
                            .concat(
                              r.options.selectItemName,
                              '"\n            type="'
                            )
                            .concat(d, '"\n            ')
                            .concat(
                              ov.sprintf('value="%s"', t[r.options.idField]),
                              '\n            '
                            )
                            .concat(
                              ov.sprintf(
                          ...
                          r.header.formatters[n] && 'string' == typeof u
                            ? u
                            : '',
                          r.options.cardView ? '</div>' : '</td>',
                        ].join('')),
                          (t[r.header.stateField] =
                            !0 === u || !!h || (u && u.checked))
          ...
          },
          {
            ...
            value: function (e, i) {
              ...
              var r = [],
                ...
                s = !1,
                l = []
              this.autoMergeCells = ov.checkAutoMergeCells(
                    ...
                    '<tr class="no-records-found">'.concat(
                      ov.sprintf(
                        ...
                        this.getVisibleFields().length +
                          ov.getDetailViewIndexOffset(this.options),
            ...
            value: function () {
              ...
              this.$body
                ...
                .on('click dblclick', function (i) {
                  ...
                  if (
                    !(
                      ...
                      n.index() - ov.getDetailViewIndexOffset(e.options) < 0
                    )
                  ) {
                    var o = n.parent(),
                      ...
                      h =
                        e.getVisibleFields()[
                          c - ov.getDetailViewIndexOffset(e.options)
                        ],
                    ...
                    if (
                      ...
                      var p = o.find(
                        ov.sprintf('[name="%s"]', e.options.selectItemName)
                      )
                      p.length && p[0].click()
                    }
                    'click' === i.type &&
                ...
                (this.$selectItem = this.$body.find(
                  ov.sprintf('[name="%s"]', this.options.selectItemName)
                )),
                ...
                this.header.events.forEach(function (i, n) {
                  ...
                  if (o) {
                    if (
                      ('string' == typeof o &&
                        (o = ov.calculateObjectValue(null, o)),
                      !o)
                    )
            ...
            value: function (e, i, n) {
              ...
              if (
                ...
                if (
                  ...
                  var d = ov.extend(
                    {},
                    ov.calculateObjectValue(null, this.options.ajaxOptions),
                    {
                      ...
                      success: function (t, i, n) {
                        var r = ov.calculateObjectValue(
                          o.options,
                          o.options.responseHandler,
                          [t, n],
                          t
                        )
                        'client' === o.options.sidePagination &&
                          o.options.paginationLoadMore &&
              ...
              if (this.$el.is(':hidden'))
                ...
                l.length > 0 &&
                  ...
                  this.$header.find('th[data-field]').each(function (i, n) {
                    e.$header_
                      .find(
                        ov.sprintf('th[data-field="%s"]', t(n).data('field'))
                      )
                      .data(t(n).data())
                  })
                for (
                ...
                u.find('> *').each(function (i, n) {
                  ...
                  if (
                    ...
                    var s = i - ov.getDetailViewIndexOffset(e.options),
                      l = e.$header_.find(
                        ov.sprintf('th[data-field="%s"]', c[s])
                      )
                  ...
                  for (o.s(); !(n = o.n()).done; ) {
                    ...
                    if (
                      ...
                      if (
                        ...
                        (u = ov.calculateObjectValue(
                          null,
                          l.footerStyle || this.options.footerStyle,
                          [l]
                        )) && u.css)
                      )
                        for (
              ...
              if (e.hasOwnProperty('field') && e.hasOwnProperty('values')) {
                ...
                this.data.forEach(function (o, r) {
                  ...
                  if (e.values.includes(o[e.field])) {
                    var a = i.$selectItem
                        .filter(':enabled')
                        .filter(ov.sprintf('[data-index="%s"]', r)),
                      s =
          ...
          },
          {
            ...
            value: function (t, e) {
              this.$body
                .find(ov.sprintf('> tr[data-index="%s"]', t))
                .next()
                .is('tr.detail-view')
                ? this.collapseRow(t)
                : this.expandRow(t, e),
          ...
          },
          {
            ...
            value: function (t, e) {
              var i = this.data[t],
                n = this.$body.find(
                  ov.sprintf('> tr[data-index="%s"][data-has-detail-view]', t)
                )
              if (
