...
<head>
    ...
    <title>Suscripción Vencida — Colecciones</title>
    <meta name="description" content="Tu suscripción ha vencido. Renueva para continuar accediendo a Colecciones.">
...
<body>
    ...
    <div class="page-header">
        <div class="icon-lock"><i class="mdi mdi-lock-outline"></i></div>
        <div class="badge-expired"><i class="mdi mdi-alert-circle-outline"></i> &nbsp;Acceso suspendido</div>
        <h1>Tu suscripción ha <span>vencido</span></h1>
        <p class="subtitle">Para continuar usando Colecciones, selecciona un plan y completa el pago a continuación.</p>
    </div>
