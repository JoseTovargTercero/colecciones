    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                <div>
                    <span id="modalDetalleAcciones"></span>
                </div>
            ...
            <form id="formReporte" data-validation="reactive">
                <div class="modal-body">
                    ...
                    <div class="row g-2 mt-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="estado_reporte">Estado</label>
                            <select class="form-select" id="estado_reporte" name="estado_reporte" data-rules="noVacio"
...
<script type="module" src="<?= BASE_URL ?>public/assets/js/modules/reportes_dano_administracion_view.js"></script>