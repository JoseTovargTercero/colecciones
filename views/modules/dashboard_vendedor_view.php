...
<div class="container-fluid flex-grow-1 container-p-y py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-1" style="color: #435971;">Mi Dashboard</h4>
            <p class="text-muted mb-0 small" id="dashSubtitle">Cargando...</p>
        </div>
        <div class="d-flex gap-2 align-items-center flex-wrap">
            ...
            <select class="form-select form-select-sm" id="dashCampania" style="width: auto; min-width: 200px; border-radius: 8px;" onchange="cargarDashboard();">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        try {
            ...
            (window._dashTemporadas || []).forEach(t => {
    ...
    async function cargarDashboard() {
        ...
        try {
            ...
            const res = await fetch(BASE + 'api/dashboard/kpis-vendedor?' + params.toString());
    ...
    function renderDashboard(d) {
        ...
        document.getElementById('dashSubtitle').innerHTML = subtitle;
            ...
            <div class="col-lg-8 mb-4 order-0">
                <div class="card h-100 bg-primary text-white">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-white">¡Bienvenido! 🎉</h5>
                                <p class="mb-4">
                                    Tus ventas actuales suman <span class="fw-bold">$${fmt(d.volumen_ventas)}</span>.
                                    Revisa el estado de tus cuotas y pagos pendientes.
                                </p>
                                <a href="${BASE}control_pagos" class="btn btn-sm btn-outline-primary">Ver Mis Pagos</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <span class="fw-semibold d-block mb-1 text-muted">Mis Ventas</span>
            ...
            <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                <div class="card">
                    <div class="row row-bordered g-0">
                        <div class="col-md-8">
                            <h5 class="card-header m-0 me-2 pb-3">Mis Asignaciones <small class="text-muted fs-6 fw-normal ms-1">(Cuotas)</small></h5>
                            <div id="chartAsignaciones" class="px-2" style="min-height: 315px;"></div>
                        </div>
                        <div class="col-md-4">
                            <div class="card-body">
    ...
    function initCharts(d) {
        ...
        _chartVendedores = new ApexCharts(document.querySelector('#chartAsignaciones'), vendedoresOpts);
        ...
        // 4. Income/Expenses Area Chart (Pagos Pendientes)
        ...
        // 5. Expenses of Week — Cuotas pendientes por fecha_pago
